...
function addPostReport(postId: string, accountId: string, content: string): Promise<any> {
...
function addCommentReport(postId: string, commentId: string, accountId: string, content: string): Promise<any> {
    const reportId = uuid.v4();
