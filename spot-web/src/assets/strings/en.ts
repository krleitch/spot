...
export const STRINGS = {
  ...
  MAIN: {
    ...
    HOME: {
      ...
      LOCATION_CREATE:
        'Enable browser location to create a spot or add comments',
      ...
      GUEST:
        'You are logged in on a guest account. Create an account to make and interact with Spots.',
    ...
    ACCOUNT: {
      ...
      GUEST:
        'You are logged in on a guest account. You will not be able to update any account information.',
      ...
      EMAIL_VERIFY_DESCRIPTION:
        'You will need to verify your email to start making spots.',
      EMAIL_ERROR: 'Email is required',
      EMAIL_INVALID: 'Invalid email',
      EMAIL_CONFIRM:
        'If you change your email you will need to verify your email again. Are you sure you would like to continue?',
      EMAIL_SUCCESS: 'Email was succesfully changed',

      USERNAME: 'Username',
      USERNAME_CONFIRM:
        'You can only change your username once every 24 hours. Are you sure you would like to continue?',
      ...
      PHONE_CONFIRM:
        'You can only change your phone once every 24 hours. Are you sure you would like to continue?',
      ...
      FACEBOOK_CONNECT_DESCRIPTION:
        'Connect with facebook to share spots with all your facebook friends'
    },
    ...
    VERIFY: {
      ...
      CONTINUE: 'Continue to Spot',
      FAILURE:
        'There was an error verifying your email. Your verification code is either invalid or expired',
      VERIFY_SEND: 'Send email verification',
      VERIFY_SENT: 'Verification email sent to'
    }
  },
  ...
  PRE_AUTH: {
    ...
    USERNAME: {
      ...
      DESCRIPTION:
        '*Your username will not be visible to anyone without your permission. All posts are anonymous',
    ...
    PASSWORD_RESET: {
      ...
      DESCRIPTION:
        'Please enter your email, you will be sent a verification code which you will need to enter to reset your password',
      ...
      REQUEST_SUCCESS:
        'An email for recovery has been sent if an account exists under this email',
