...
export class CommentService {
  ...
  getComments(request: GetCommentsRequest): Observable<GetCommentsSuccess> {
    ...
    return this.http.get<GetCommentsSuccess>(
  ...
  ): Observable<DeleteCommentSuccess> {
    return this.http.delete<DeleteCommentSuccess>(
  ...
  getReplies(request: GetRepliesRequest): Observable<GetRepliesSuccess> {
    ...
    params = params.append('limit', request.limit.toString());
    return this.http.get<GetRepliesSuccess>(
      `${this.baseUrl}/comments/${request.postId}/${request.commentId}`,
      { params }
    );
  }
  ...
  addReply(request: AddReplyRequest): Observable<AddReplySuccess> {
    ...
    return this.http.post<AddReplySuccess>(
      `${this.baseUrl}/comments/${request.postId}/${request.commentId}`,
      formData
    );
  }
  ...
  deleteReply(request: DeleteReplyRequest): Observable<DeleteReplySuccess> {
    return this.http.delete<DeleteReplySuccess>(
  ...
  likeComment(request: LikeCommentRequest): Observable<LikeCommentSuccess> {
    return this.http.put<LikeCommentSuccess>(
      `${this.baseUrl}/comments/${request.postId}/${request.commentId}/like`,
      request
    );
  }
  ...
  ): Observable<DislikeCommentSuccess> {
    return this.http.put<DislikeCommentSuccess>(
      `${this.baseUrl}/comments/${request.postId}/${request.commentId}/dislike`,
      request
    );
  }

  unratedComment(
    request: UnratedCommentRequest
  ): Observable<UnratedCommentSuccess> {
    return this.http.put<UnratedCommentSuccess>(
      `${this.baseUrl}/comments/${request.postId}/${request.commentId}/unrated`,
      request
    );
  }
  ...
  ): Observable<ReportCommentSuccess> {
    return this.http.put<ReportCommentSuccess>(
  ...
  getActivity(
  ...
  ): Observable<ActivityCommentSuccess> {
    let params = new HttpParams();
    if (request.before) {
    ...
    params = params.append('limit', request.limit.toString());
    return this.http.get<ActivityCommentSuccess>(
  ...
  likeReply(request: LikeReplyRequest): Observable<LikeReplySuccess> {
    return this.http.put<LikeReplySuccess>(
      `${this.baseUrl}/comments/${request.postId}/${request.parentId}/${request.commentId}/like`,
      request
    );
  }
  ...
  dislikeReply(request: DislikeReplyRequest): Observable<DislikeReplySuccess> {
    return this.http.put<DislikeReplySuccess>(
      `${this.baseUrl}/comments/${request.postId}/${request.parentId}/${request.commentId}/dislike`,
      request
    );
  }
  ...
  unratedReply(request: UnratedReplyRequest): Observable<UnratedReplySuccess> {
    return this.http.put<UnratedReplySuccess>(
      `${this.baseUrl}/comments/${request.postId}/${request.parentId}/${request.commentId}/unrated`,
      request
    );
  }
  ...
  getProfilePictureClass(index): string {
    ...
    return (
      'profile p' + (index % (COMMENTS_CONSTANTS.PROFILE_COLORS_COUNT + 1))
    );
  }
