...
export const selectAccountLoadingFromStore = (state: State): boolean =>
  state.accountLoading;
export const selectAccountMetadataFromStore = (state: State): AccountMetadata =>
  state.accountMetadata;
export const selectLoadingLocationFromStore = (state: State): boolean =>
  state.loadingLocation;
export const selectLocationFromStore = (state: State): Location =>
  state.location;
...
export const selectFacebookConnectedFromStore = (state: State): boolean =>
  state.account && state.account.facebook_id == null ? false : true;
export const selectGoogleConnectedFromStore = (state: State): boolean =>
  state.account && state.account.google_id == null ? false : true;
...
export const selectIsAuthenticatedFromStore = (state: State): boolean =>
  state.account ? true : false;
export const selectIsVerifiedFromStore = (state: State): boolean =>
  state.account ? (state.account.verified_date ? true : false) : false;

export const selectAccountsState: MemoizedSelector<object, State> =
...
export const selectLocation: MemoizedSelector<object, Location> =
  createSelector(selectAccountsState, selectLocationFromStore);

export const selectLocationFailure: MemoizedSelector<object, string> =
  createSelector(selectAccountsState, selectLocationFailureFromStore);

export const selectLocationTimeReceived: MemoizedSelector<object, Date> =
  createSelector(selectAccountsState, selectLocationTimeReceivedFromStore);

export const selectLoadingLocation: MemoizedSelector<object, boolean> =
  createSelector(selectAccountsState, selectLoadingLocationFromStore);

export const selectFacebookConnected: MemoizedSelector<object, any> =
  createSelector(selectAccountsState, selectFacebookConnectedFromStore);

export const selectGoogleConnected: MemoizedSelector<object, any> =
  createSelector(selectAccountsState, selectGoogleConnectedFromStore);

export const selectAuthenticationError: MemoizedSelector<object, SpotError> =
  createSelector(selectAccountsState, selectAuthenticationErrorFromStore);

export const selectAuthenticationSuccess: MemoizedSelector<object, boolean> =
  createSelector(selectAccountsState, selectAuthenticationSuccessFromStore);

export const selectIsAuthenticated: MemoizedSelector<object, boolean> =
  createSelector(selectAccountsState, selectIsAuthenticatedFromStore);

export const selectIsVerified: MemoizedSelector<object, boolean> =
  createSelector(selectAccountsState, selectIsVerifiedFromStore);

export const selectAccountMetadata: MemoizedSelector<object, AccountMetadata> =
  createSelector(selectAccountsState, selectAccountMetadataFromStore);

export const selectAccountLoading: MemoizedSelector<object, boolean> =
  createSelector(selectAccountsState, selectAccountLoadingFromStore);
