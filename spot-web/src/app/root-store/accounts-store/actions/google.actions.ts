...
import { GoogleConnectRequest, GoogleConnectResponse, GoogleDisconnectRequest, GoogleDisconnectResponse } from '@models/accounts';
...
export type GoogleActions = GoogleLoginRequestAction | GoogleLoginSuccessAction | GoogleLoginFailureAction |
                            GoogleConnectRequestAction | GoogleConnectSuccessAction | GoogleConnectFailureAction |
                            GoogleDisconnectRequestAction | GoogleDisconnectSuccessAction | GoogleDisconnectFailureAction;
