...
export const selectCreatePostsErrorFromStore = (state: State): SpotError =>
  state.createError;
export const selectCreatePostsSuccessFromStore = (state: State): boolean =>
  state.createSuccess;
export const selectNoPostsFromStore = (state: State): boolean => state.noPosts;

export const selectPostsState: MemoizedSelector<object, State> =
...
export const selectCreatePostsError: MemoizedSelector<object, SpotError> =
  createSelector(selectPostsState, selectCreatePostsErrorFromStore);

export const selectCreatePostsSuccess: MemoizedSelector<object, boolean> =
  createSelector(selectPostsState, selectCreatePostsSuccessFromStore);
