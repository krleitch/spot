...
export type FacebookActions =
  | FacebookLoginRequestAction
  | FacebookLoginSuccessAction
  | FacebookLoginFailureAction
  | FacebookConnectRequestAction
  | FacebookConnectSuccessAction
  | FacebookConnectFailureAction
  | FacebookDisconnectRequestAction
  | FacebookDisconnectSuccessAction
  | FacebookDisconnectFailureAction;
